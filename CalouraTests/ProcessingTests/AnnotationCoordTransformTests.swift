...
final class AnnotationCoordTransformTests: XCTestCase {
    ...
    func testScale_imageMatchesCanvas_returnsOne() {
        let transform = AnnotationCoordTransform(imageSize: CGSize(width: 800, height: 600),
                                                 canvasSize: CGSize(width: 800, height: 600))
        XCTAssertEqual(transform.scale, 1.0, accuracy: 0.001)
    }

    func testScale_imageLargerThanCanvas_returnsRatio() {
        let transform = AnnotationCoordTransform(imageSize: CGSize(width: 1920, height: 1080),
                                                 canvasSize: CGSize(width: 800, height: 450))
        // 1920 / 800 = 2.4
        XCTAssertEqual(transform.scale, 2.4, accuracy: 0.001)
    }
    ...
    func testImageFrame_horizontalLetterbox() {
        ...
        let transform = AnnotationCoordTransform(imageSize: CGSize(width: 1080, height: 1920),
                                                 canvasSize: CGSize(width: 800, height: 800))
        let frame = transform.imageFrame
    ...
    func testViewToImage_identity_whenCanvasMatchesImage() {
        let transform = AnnotationCoordTransform(imageSize: CGSize(width: 800, height: 600),
                                                 canvasSize: CGSize(width: 800, height: 600))
        let result = transform.viewToImage(CGPoint(x: 400, y: 300))
    ...
    func testViewToImage_scaledDown() {
        ...
        let transform = AnnotationCoordTransform(imageSize: CGSize(width: 1920, height: 1080),
                                                 canvasSize: CGSize(width: 800, height: 450))
        let result = transform.viewToImage(CGPoint(x: 400, y: 225))
    ...
    func testViewToImage_topLeftCorner() {
        let transform = AnnotationCoordTransform(imageSize: CGSize(width: 1920, height: 1080),
                                                 canvasSize: CGSize(width: 800, height: 450))
        let result = transform.viewToImage(CGPoint(x: 0, y: 0))
    ...
    func testViewToImage_withHorizontalLetterbox() {
        ...
        let topLeft = transform.viewToImage(CGPoint(x: 175, y: 0))
        XCTAssertEqual(topLeft.x, 0, accuracy: 0.001)
        XCTAssertEqual(topLeft.y, 0, accuracy: 0.001)
    }
    ...
    func testViewToImage_zeroCanvasSize_returnsOriginal() {
        let transform = AnnotationCoordTransform(imageSize: CGSize(width: 1920, height: 1080),
                                                 canvasSize: .zero)
        let result = transform.viewToImage(CGPoint(x: 100, y: 200))
